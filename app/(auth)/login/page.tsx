...
const GoogleDisclaimer = () => (
    <p className="mt-4 text-center text-[10px] text-gray-400 leading-normal px-4 max-w-xs mx-auto">
...
const GoogleIcon = () => (
    <svg viewBox="0 0 24 24" className="w-5 h-5" aria-hidden="true">
        <path d="M12.0003 20.45c4.6653 0 
        8.577-3.9116 8.577-8.577 
        0-.7567-.089-1.4883-.243-2.185h-8.334v4.145h4.945c-.4825 2.155-2.22 
        3.8266-4.945 3.8266-2.9467 0-5.3334-2.3867-5.3334-5.3334s2.3867-5.3333 
        5.3334-5.3333c1.3534 0 2.5834.4716 3.5517 1.2533l3.015-3.015C16.8903 
        3.655 14.6053 2.6233 12.0003 2.6233 6.822 2.6233 2.6237 6.8216 2.6237 
        12s4.1983 9.3766 9.3766 8.45z" fill="currentColor" />
    </svg>
)
